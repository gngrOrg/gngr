...
public class JavaFunctionObject extends ScriptableObject implements Function {
  // public class JavaFunctionObject extends BaseFunction implements Function {
  ...
  public JavaFunctionObject(final String name, final String className) {
    ...
    defineProperty("call", new Callable() {
      ...
      public Object call(final Context cx, final Scriptable scope, final Scriptable thisObj, final Object[] args) {
        System.out.println("Calling via function object: " + methodName);
  ...
  private MethodAndArguments getBestMethod(final Object[] args) {
    ...
    if (exactMethod != null) {
      // System.out.println("Found exact method: " + exactMethod);
      return exactMethod;
    }
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (args == null) {
        ...
        if (Objects.areAssignableTo(args, parameterTypes)) {
          ...
          // System.out.println("Actual args: " + Arrays.toString(actualArgs));
  ...
  public Object call(final Context cx, final Scriptable scope, final Scriptable thisObj, final Object[] args) {
    // System.out.println("Going to call " + methodName + " in scope: " + Arrays.toString(scope.getIds()));
